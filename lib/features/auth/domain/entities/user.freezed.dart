...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, fullName: $fullName, role: $role, status: $status, course: $course, groupCode: $groupCode, phone: $phone, university: $university, faculty: $faculty, specialty: $specialty, isBlocked: $isBlocked, rejectReason: $rejectReason)';
  }
...
abstract class _User extends User {
  const factory _User(
      ...
      final String? specialty,
      final bool isBlocked,
      final String? rejectReason}) = _$UserImpl;
