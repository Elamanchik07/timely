...
mixin _$UserModel {
  ...
  String get role => throw _privateConstructorUsedError; // 'STUDENT' or 'ADMIN'
  String get status =>
...
// 'PENDING', 'APPROVED', 'REJECTED'
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, fullName: $fullName, email: $email, role: $role, status: $status, groupCode: $groupCode, phone: $phone, avatar: $avatar, faculty: $faculty, course: $course)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, fullName, email, role,
      status, groupCode, phone, avatar, faculty, course);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final String? avatar,
      final String? faculty,
      final int? course}) = _$UserModelImpl;
