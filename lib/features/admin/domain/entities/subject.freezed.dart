...
class _$SubjectImpl implements _Subject {
  const _$SubjectImpl(
      {this.id, required this.name, this.shortName, this.color, this.icon});
  ...
  @override
  String toString() {
    return 'Subject(id: $id, name: $name, shortName: $shortName, color: $color, icon: $icon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, shortName, color, icon);
